...
urlpatterns = [
    ...
    path('payment-successful/', CheckoutSuccessfulView.as_view(), name='payment_success'),
    path('payment-cancelled', CheckoutCancelledView.as_view(), name='payment_cancelled'),
]
